...
<body class="min-h-screen flex flex-col items-center justify-start p-6 bg-gradient-to-br from-green-100 via-blue-100 to-yellow-100">
  ...
  <div class="w-full max-w-6xl mb-8 text-center">
    <img src="images/myrecycleimage.jpg" alt="Recycling" class="mx-auto w-96 h-auto rounded-3xl shadow-2xl animate-float border-4 border-green-400" />
  ...
  <!-- Recycling Form -->
  <form action="submit.php" method="POST" class="overlay max-w-xl w-full mx-auto p-8 rounded-2xl shadow-2xl border-2 border-green-300">
